      ...
      >
        <div class="navbar-mobile">
          ...
          <ul class="navbar-mobile--body">
            <li class="nav-item">
              <nuxt-link class="nav-link" aria-current="page" to="/home"
                >Home</nuxt-link
              >
            </li>
        ...
        <div class="container header-content">
          <div class="navbar-item navbar-itemLogo">
            <a class="navbar-brand">
              <!-- <img src="/assets//assets/images/logo.png" alt="Brand" /> -->
              <nuxt-link class="lurc" to="/home"
                ><span class="lurc1">RESEARCH</span
                ><span class="lurc2">COMMUNITY</span>
              </nuxt-link>
            </a>
          ...
          <div class="navbar-item">
            <ul class="navbar-item__action">
              ...
              <li>
                <nuxt-link :to="`/profile/${authUser.slug}/${authUser.id}`"
                  ><img
                    :src="authUser.image"
                    alt="img"
